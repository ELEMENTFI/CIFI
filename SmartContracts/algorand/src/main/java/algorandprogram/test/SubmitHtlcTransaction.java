...
public class SubmitHtlcTransaction 
{
    public static void main(String args[]) throws Exception {
        ...
        int maxFee = 2000;
        Address owner = new Address("DVJ6M4SRCZW3VTUUKSZYP3JLQS7UFJAJ4O45ARANL2HXV3RRY6YFDIAHE4");
        Address receiver = new Address("I5RBEV7YXFWX6IONZWH5KPRSQAZZ7HKWBFSSYSDH5IALQSYOKJKP5UH2MQ");
