...
const CreateAsset=async()=>{
  ...
  console.log("hello",recoveredAccount3.address);
  //alert(accts[0]);
  console.log("def",accts[0]);
  // var recoveredAccount1 = accts[0];
  // var recoveredAccount2 = accts[0];
  // var recoveredAccount3 = accts[0];
