...
export class Account extends BaseModel {
     ...
     * * lsig
     */
    constructor({ address, amount, amountWithoutPendingRewards, pendingRewards, rewards, round, status, appsLocalState, appsTotalSchema, assets, authAddr, createdApps, createdAssets, participation, rewardBase, sigType, }) {
        super();
...
export class ApplicationParams extends BaseModel {
     ...
     */
    constructor({ approvalProgram, clearStateProgram, creator, globalState, globalStateSchema, localStateSchema, }) {
        super();
...
export class AssetParams extends BaseModel {
     ...
     */
    constructor({ creator, decimals, total, clawback, defaultFrozen, freeze, manager, metadataHash, name, reserve, unitName, url, }) {
        super();
        this.creator = creator;
