...
exports.LogicTemplates = exports.tealSignFromProgram = exports.tealSign = exports.logicSigFromByte = exports.signLogicSigTransactionObject = exports.signLogicSigTransaction = exports.makeLogicSig = exports.assignGroupID = exports.computeGroupID = exports.INVALID_MICROALGOS_ERROR_MSG = exports.algosToMicroalgos = exports.microalgosToAlgos = exports.masterDerivationKeyToMnemonic = exports.mnemonicToMasterDerivationKey = exports.modelsv2 = exports.mnemonicToSecretKey = exports.secretKeyToMnemonic = exports.generateAccount = exports.decodeUint64 = exports.encodeUint64 = exports.decodeAddress = exports.encodeAddress = exports.isValidAddress = exports.Indexer = exports.IntDecoding = exports.Kmd = exports.Algodv2 = exports.ERROR_INVALID_MICROALGOS = exports.ERROR_MULTISIG_BAD_SENDER = exports.decodeObj = exports.encodeObj = exports.multisigAddress = exports.appendSignMultisigTransaction = exports.mergeMultisigTransactions = exports.signMultisigTransaction = exports.verifyBytes = exports.signBytes = exports.signBid = exports.signTransaction = exports.MULTISIG_BAD_SENDER_ERROR_MSG = exports.Algod = void 0;
...
const algod_1 = __importDefault(require("./client/algod"));
const convert = __importStar(require("./convert"));
const utils = __importStar(require("./utils/utils"));
exports.Algod = algod_1.default.Algod;
...
function signMultisigTransaction(txn, { version, threshold, addrs }, sk) {
    ...
    if (Object.prototype.hasOwnProperty.call(txn, 'from')) {
        const actualSender = typeof txn.from === 'string'
            ? txn.from
            : address.encodeAddress(txn.from.publicKey);
        if (actualSender !== expectedFromRaw) {
            throw new Error(exports.MULTISIG_BAD_SENDER_ERROR_MSG);
        }
    }
    else {
        // eslint-disable-next-line no-param-reassign
...
var algod_2 = require("./client/v2/algod/algod");
Object.defineProperty(exports, "Algodv2", { enumerable: true, get: function () { return __importDefault(algod_2).default; } });
...
var mnemonic_2 = require("./mnemonic/mnemonic");
Object.defineProperty(exports, "mnemonicToMasterDerivationKey", { enumerable: true, get: function () { return mnemonic_2.mnemonicToMasterDerivationKey; } });
Object.defineProperty(exports, "masterDerivationKeyToMnemonic", { enumerable: true, get: function () { return mnemonic_2.masterDerivationKeyToMnemonic; } });
...
var logicTemplates_1 = require("./logicTemplates");
Object.defineProperty(exports, "LogicTemplates", { enumerable: true, get: function () { return __importDefault(logicTemplates_1).default; } });
