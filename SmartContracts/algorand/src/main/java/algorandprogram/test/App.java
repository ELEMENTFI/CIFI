...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] values = {"3D4YHZ7Scg3Ucg5sMA8xl8NghVCpeoRT7f3NNk3I "};
        
        AlgodClient client = new AlgodClient(ALGOD_API_ADDR, ALGOD_PORT, ALGOD_API_TOKEN);

        final String SRC_ACCOUNT = "combine lab pottery acoustic improve town lounge gesture cheap what help stumble pretty around jungle weasel actual motor tonight hospital broken detail eager abstract bike"; 
