...
public class MainBinance {
	...
	public static void main(String[] args) throws IOException, ParseException,InvalidFormatException{
		...
		//Web3j web3=Web3j.build(new HttpService("https://apis.ankr.com/ce2998490ddf425d97b219586b83c9ba/f332218c35d82089e9302d8dd7865305"));
		...
		for (int j = 0; j < columns.length; j++) {
		 ...
		 try {
			 ...
			 String urll="https://api.bscscan.com/api?module=account&action=tokentx&address=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c&startblock=0&endblock=999999&sort=asc&apikey=26NPBCN1ZIZ33YJKKJ24MSY9GB6I6I4NVQ";
...
//			    
			...
			FileOutputStream fileOutt = new FileOutputStream("contactsBinance.xlsx");
